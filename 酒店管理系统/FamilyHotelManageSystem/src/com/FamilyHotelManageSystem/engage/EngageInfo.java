 ...
 *##############################################################################
 */
package com.FamilyHotelManageSystem.engage;
...
import com.FamilyHotelManageSystem.sunsdk.swing.TJTextArea;
import com.FamilyHotelManageSystem.sunsdk.swing.TJTextField;
import com.FamilyHotelManageSystem.sunsdk.swing.sunswing;

public class EngageInfo extends JDialog implements ActionListener,MouseListener {
	...
	public EngageInfo (JDialog dialog) {
		...
		this.setResizable(false);		//允许改变窗口大小(NO)
		pack();
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(o==bt1) {
			...
			if(!suntools.isNum(c_tel)||c_tel.equals("")) {
				//判断电话是否由数字组成
