 ...
 *##############################################################################
 */
package com.FamilyHotelManageSystem.customer;
...
public class AddHuiYuan extends JDialog implements ActionListener,MouseListener {
			...
			if(m_id.equals("")||m_name.equals("")||zj_no.equals("")||m_tel.equals("")||address.equals("")) {
				...
				try {
					...
					if(rs.next()) {
						...
						tf1.requestFocus();
						tf1.setText("");
					}else if(!suntools.isNum(tf4.getText())) {
						//判断电话是否由数字组成
