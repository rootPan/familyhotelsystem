...
import com.FamilyHotelManageSystem.sunsdk.sql.*;
import com.FamilyHotelManageSystem.sunsdk.swing.*;


public class LeftBottPanel extends JPanel implements ActionListener, MouseListener, FocusListener {
	...
	public void actionPerformed (ActionEvent ae) {
		try {
			...
			if(rs.next()) {
				...
				" ] 的房间信息", "友情提示", JOptionPane.INFORMATION_MESSAGE);
			}//Endif
	    }
	    catch (Exception ex) {
